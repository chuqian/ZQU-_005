...
<link href="./customerFile/css/cartstyle.css" rel="stylesheet" type="text/css" />

<link href="./customerFile/css/jsstyle.css" rel="stylesheet" type="text/css" />

<script type="text/javascript" src="./customerFile/js/address.js"></script>
...
<body>
	...
	<div class="concent">
		...
		<div class="paycont">
				...
				<ul>
					...
					<li class="user-addresslist defaultAddr">
						...
						<div class="address-right">
							<a href="./tongwebinf?url=person/address"> <span
			...
			<div class="logistics">
				<h3>选择支付方式</h3>
				<ul class="pay-list">
					<li class="pay card"><img src="./customerFile/images/wangyin.jpg" />银联<span></span></li>
					<li class="pay qq"><img src="./customerFile/images/weizhifu.jpg" />微信<span></span></li>
					<li class="pay taobao"><img src="./customerFile/images/zhifubao.jpg" />支付宝<span></span></li>
				</ul>
			</div>
			<div class="clear"></div>
										...
										<li class="td td-item">
											<div class="item-pic">
												<a href="#" class="J_MakePoint"> <img
													src="./customerFile/images/kouhong.jpg_80x80.jpg"
				...
				<div class="pay-confirm clearfix">
					...
					<div id="holyshit269" class="submitOrder">
						<div class="go-btn-wrap">
							<a id="J_Go" href="./tongwebinf?url=home/success" class="btn-go" tabindex="0"
	...
	<div class="clear"></div>
	<script src="./customerFile/js/_webinfoheader.js"></script>
