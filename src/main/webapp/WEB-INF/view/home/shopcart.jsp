...
<link href="./customerFile/css/optstyle.css" rel="stylesheet" type="text/css" />

<script type="text/javascript" src="./customerFile/js/jquery.js"></script>
...
<body>
	...
	<div class="concent">
		...
		<div class="float-bar-wrapper">
			...
			<div class="float-bar-right">
				...
				<div class="btn-area">
					<a href="./tongwebinf?url=home/pay" id="J_Go" class="submit-btn submit-btn-disabled"
		...
		<div class="theme-popbod dform">
			<form class="theme-signin" name="loginform" action="" method="post">
				...
				<div class="theme-signin-right">
					<div class="img-info">
						<img src="./customerFile/images/kouhong.jpg_80x80.jpg" />
					</div>
					<div class="text-info">
	...
	<div class="navCir">
		...
		<li class="active"><a href="./tongwebinf?url=home/shopcart"><i class="am-icon-shopping-basket"></i>购物车</a></li>
