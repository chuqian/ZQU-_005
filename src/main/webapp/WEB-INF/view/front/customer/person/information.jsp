...
<script src="./customerFile/AmazeUI-2.4.2/assets/js/amazeui.js"
	type="text/javascript"></script>
					...
					<div class="user-infoPic">
						...
						<div class="filePic">
							<input type="file" class="inputPic"
								...
								src="./customerFile/images/getAvatar.do.jpg" alt="" />
						</div>
						...
						<form class="am-form am-form-horizontal">
							...
							<div class="am-form-group address">
								...
								<div class="am-form-content address">
									<a href="./tongwebinf?url=person/address">
										<p class="new-mu_l2cw">
							...
							<div class="am-form-group safety">
								...
								<div class="am-form-content safety">
									<a href="./tongwebinf?url=person/safety"> <span class="am-icon-angle-right"></span>
