...
<html>
	<head>
		...
		<link href="./customerFile/css/infstyle.css" rel="stylesheet" type="text/css">
	</head>
	<body>
		<!--头 -->
				...
				<div class="main-wrap">
					...
					<div class="user-safety">
						...
						<div class="user-infoPic">
							...
							<div class="filePic">
								<img class="am-circle am-img-thumbnail" src="./customerFile/images/getAvatar.do.jpg" alt="" />
							</div>
						...
						<div class="check">
							<ul>
								<li>
									...
									<div class="fore3">
										<a href="./tongwebinf?url=person/password">
								...
								<li>
									...
									<div class="fore3">
										<a href="./tongwebinf?url=person/setpay">
								...
								<li>
									...
									<div class="fore3">
										<a href="./tongwebinf?url=person/bindphone">
								...
								<li>
									...
									<div class="fore3">
										<a href="./tongwebinf?url=person/email">
											<div class="am-btn am-btn-secondary">换绑</div>
										</a>
									</div>
								</li>
								<li>
									...
									<div class="fore3">
										<a href="./tongwebinf?url=person/idcard">
