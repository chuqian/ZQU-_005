...
<link href="./customerFile/css/systyle.css" rel="stylesheet" type="text/css">
...
<body>
		...
		<div class="col-main">
			<div class="main-wrap">
					...
					<div class="wrap-list">
						<div class="m-user">
							...
							<div class="m-userinfo">
								<div class="m-baseinfo">
									<a href="./tongwebinf?url=person/information"> <img
										src="./customerFile/images/getAvatar.do.jpg">
								...
								<div class="m-right">
									<div class="m-new">
										<a href="./tongwebinf?url=person/news"><i class="am-icon-bell-o"></i>消息</a>
									</div>
									<div class="m-address">
										<a href="./tongwebinf?url=person/address" class="i-trigger">我的收货地址</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="m-order">
							<div class="s-bar">
								<i class="s-icon"></i>我的订单 <a class="i-load-more-item-shadow"
									href="./tongwebinf?url=person/order">全部订单</a>
							</div>
							<ul>
								<li><a href="./tongwebinf?url=person/order"><i><img
											src="./customerFile/images/pay.png" /></i><span>待付款</span></a></li>
								<li><a href="./tongwebinf?url=person/order"><i><img
											src="./customerFile/images/send.png" /></i><span>待发货<em class="m-num">1</em></span></a></li>
								<li><a href="./tongwebinf?url=person/order"><i><img
											src="./customerFile/images/receive.png" /></i><span>待收货</span></a></li>
								<li><a href="./tongwebinf?url=person/order"><i><img
											src="./customerFile/images/comment.png" /></i><span>待评价<em
											class="m-num">3</em></span></a></li>
								<li><a href="./tongwebinf?url=person/change"><i><img
											src="./customerFile/images/refund.png" /></i><span>退换货</span></a></li>
							</ul>
						</div>
						<!--九宫格-->
						<div class="user-patternIcon">
							...
							<ul>
								...
								<a href="./tongwebinf?url=home/shopcart"><li class="am-u-sm-4"><i
										class="am-icon-shopping-basket am-icon-md"></i><img
										src="./customerFile/images/iconbig.png" />
									<p>购物车</p></li></a>
								<a href="./tongwebinf?url=person/collection"><li class="am-u-sm-4"><i
										class="am-icon-heart am-icon-md"></i><img
										src="./customerFile/images/iconsmall1.png" />
									<p>我的收藏</p></li></a>
								<a href="./unitShop/home.jsp"><li class="am-u-sm-4"><i
										class="am-icon-gift am-icon-md"></i><img
										src="./customerFile/images/iconsmall0.png" />
									<p>为你推荐</p></li></a>
								<a href="./tongwebinf?url=person/comment"><li class="am-u-sm-4"><i
										class="am-icon-pencil am-icon-md"></i><img
										src="./customerFile/images/iconsmall3.png" />
									<p>好评宝贝</p></li></a>
							</ul>
						</div>
						<!--物流 -->
						<div class="m-logistics">
							...
							<div class="s-content">
								<ul class="lg-list">
									...
									<li class="lg-item">
										<div class="item-info">
											<a href="./unitShop/introduction.jsp"> <img
												src="./customerFile/images/65.jpg_120x120xz.jpg"
										...
										<div class="lg-info">
											...
											<div class="lg-detail-wrap">
												<a class="lg-detail i-tip-trigger" href="./tongwebinf?url=person/logistics">查看物流明细</a>
										...
										<div class="lg-confirm">
											<a class="i-btn-typical" href="./tongwebinf?url=person/orderinfo">确认收货</a>
										</div>
									</li>
									<div class="clear"></div>
									...
									<li class="lg-item">
										<div class="item-info">
											<a href="./unitShop/introduction.jsp"> <img
												src="./customerFile/images/88.jpg_120x120xz.jpg"
							...
							<div class="s-content">
								<div class="s-item-wrap">
									<div class="s-item">
										...
										<div class="s-pic">
											<a href="./unitShop/introduction.jsp" class="s-pic-link"> <img
												src="./customerFile/images/0-item_pic.jpg_220x220.jpg"
										...
										<div class="s-title">
											<a href="./unitShop/introduction.jsp"
												title="包邮s925纯银项链女吊坠短款锁骨链颈链日韩猫咪银饰简约夏配饰">包邮s925纯银项链女吊坠短款锁骨链颈链日韩猫咪银饰简约夏配饰</a>
										</div>
									...
									<div class="s-item">
										...
										<div class="s-pic">
											<a href="#" class="s-pic-link"> <img
												src="./customerFile/images/1-item_pic.jpg_220x220.jpg"
								...
								<div class="s-item-wrap">
									<div class="s-item">
										...
										<div class="s-pic">
											<a href="#" class="s-pic-link"> <img
												src="./customerFile/images/-0-saturn_solar.jpg_220x220.jpg"
				...
				<div class="wrap-right">
					...
					<div class="day-list">
						<div class="s-bar">
							<a class="i-history-trigger s-icon"></a>我的日历 <a
								class="i-setting-trigger s-icon"></a>
						</div>
					...
					<div class="new-goods">
						<div class="s-bar">
							<i class="s-icon"></i>今日新品 <a class="i-load-more-item-shadow" href="">更多&gt;&gt;</a>
						</div>
						<div class="new-goods-info">
							<a class="shop-info" href="./unitShop/introduction.jsp"
								target="_blank">
								<div class="face-img-panel">
									<img src="./customerFile/images/imgsearch1.jpg" alt="">
	...
	<div class="navCir">
		...
		<li class="active"><a href="./tongwebinf?url=person/index"><i class="am-icon-user"></i>我的</a></li>
	</div>
