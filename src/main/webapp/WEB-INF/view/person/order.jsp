...
<link href="./customerFile/css/orstyle.css" rel="stylesheet" type="text/css">
												...
												<div class="order-left">
													...
													<ul class="item-list">
														<li class="td td-item">
															<div class="item-pic">
																<a href="./unitShop/introduction.jsp" class="J_MakePoint"> <img
																	src="./customerFile/images/62988.jpg_80x80.jpg"
																	class="itempic J_ItemImg">
																</a>
															</div>
															<div class="item-info">
													...
													<div class="move-right">
														<li class="td td-status">
															<div class="item-status">
																...
																<p class="order-info">
																	<a href="./tongwebinf?url=person/orderinfo">订单详情</a>
																</p>
																<p class="order-info">
																	<a href="./tongwebinf?url=person/logistics">查看物流</a>
																</p>
															</div>
														</li>
													...
													<ul class="item-list">
														...
														<li class="td td-operation">
															<div class="item-operation">
																<a href="./tongwebinf?url=person/refund">退款</a>
															</div>
														</li>
													</ul>
											...
											<div class="order-content">
												<div class="order-left">
													<ul class="item-list">
														...
														<li class="td td-operation">
															<div class="item-operation">
																<a href="./tongwebinf?url=person/refund">退款/退货</a>
															</div>
														</li>
													</ul>
											...
											<div class="order-content">
												...
												<div class="order-right">
													...
													<div class="move-right">
														...
														<li class="td td-change"><a href="./tongwebinf?url=home/pay">
											...
											<div class="order-content">
												...
												<div class="order-right">
													...
													<div class="move-right">
														...
														<li class="td td-change"><a href="./tongwebinf?url=person/commentlist">
