					...
					<div class="user-orderinfo">
						...
						<div class="order-infoaside">
							<div class="order-logistics">
								<a href="./tongwebinf?url=person/logistics">
									<div class="icon-log">
										<i><img src="./customerFile/images/receive.png"></i>
									</div>
									<div class="latest-logistics">
										...
										<div class="inquire">
											...
											<a href="./tongwebinf?url=person/logistics">查看</a>
										</div>
									</div>
									...
									<div class="order-content">
										<div class="order-left">
											<ul class="item-list">
												<li class="td td-item">
													<div class="item-pic">
														<a href="./unitShop/introduction.jsp" class="J_MakePoint">
											...
											<ul class="item-list">
												<li class="td td-item">
													<div class="item-pic">
														<a href="./unitShop/introduction.jsp" class="J_MakePoint">
															<img src="./customerFile/images/62988.jpg_80x80.jpg" class="itempic J_ItemImg">
														</a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
