				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="../customerFile/images/01.jpg" title="pic" />
								</li>
								<li>
									<img src="../customerFile/images/02.jpg" />
								</li>
								<li>
									<img src="../customerFile/images/03.jpg" />
								</li>
							</ul>
						</div>
					</section>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="../customerFile/images/01.jpg"><img src="../customerFile/images/01_mid.jpg" alt="细节展示放大镜特效" rel="../customerFile/images/01.jpg" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="../customerFile/images/01_small.jpg" mid="../customerFile/images/01_mid.jpg" big="../customerFile/images/01.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="../customerFile/images/02_small.jpg" mid="../customerFile/images/02_mid.jpg" big="../customerFile/images/02.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="../customerFile/images/03_small.jpg" mid="../customerFile/images/03_mid.jpg" big="../customerFile/images/03.jpg"></a>
									</div>
								</li>
							</ul>
						</div>
				 ...
				 良品铺子 手剥松子218g 坚果炒货 巴西松子
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								...
								<li class="price iteminfo_mktprice">
									<dt>快递费</dt>
									<dd><em>¥</em><b class="sys_item_freprice">10</b>元</dd>									
								</li>
								<div class="clear"></div>
							</div><br>
					    ...
					    <div class="mc"> 
						     <ul>					    
						     	<div class="mt">            
							      ...
							      <li class="first">
							      	<div class="p-img">                    
							      		<a  href="#"> <img class="" src="../customerFile/images/browse1.jpg"> </a>               
							      	</div>
								...
								<div class="am-tab-panel am-fade am-in am-active">
									...
									<div class="details">
										...
										<div class="twlistNews">
											<img src="../customerFile/images/tw1.jpg" />
											<img src="../customerFile/images/tw2.jpg" />
											<img src="../customerFile/images/tw3.jpg" />
											<img src="../customerFile/images/tw4.jpg" />
											<img src="../customerFile/images/tw5.jpg" />
											<img src="../customerFile/images/tw6.jpg" />
											<img src="../customerFile/images/tw7.jpg" />
										</div>
									</div>
									<div class="clear"></div>
								</div>
